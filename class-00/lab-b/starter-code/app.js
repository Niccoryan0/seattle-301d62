...
// It refers to the object, joe, and logs all of the properties associated with it.
// 2. What is "this" when joe.scopeArrow() is invoked?
// The entire window of the document
// 3. Explain why "this" is different when an arrow function is used.
// When the arrow funciton is used the object is no longer recognized within the function, meaning "this" no longer can refer to a specific object, and instead refers to the Window object itself.
